...
<div style="position:relative; padding-left:50px;">
  <img src="/uploads/avatars/{{ $user->avatar }}" style="width:40px; height:40px; position:absolute; top:0px; left:0px; border-radius:50%">
  {{ $user->name }}
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    @endforeach
    @else
    <p>User has not written any post till now.</p>
    @endif
  </div>
</div>
<div class="panel panel-default">
  ...
  <div class="list-group">
    ...
    @else
    <div class="list-group-item">
      <p>User has not commented till now.</p>
    </div>
    @endif
  </div>
</div>
